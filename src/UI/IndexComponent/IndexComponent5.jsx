...
function IndexComponent5() {
  return (
    <div className=" bg-[#E7F0DC] pb-3">
      ...
      <div className=" min-h-[400px] w-[90%] md:w-[70%] bg-[] grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5 ">
        <div className="h-[460px] bg-white p-5">
            ...
            <div className="  text-center flex flex-col items-center">
                ...
                <p className=' mt-3'>Lorem ipsum, dolor sit amet  rerum nesciunt maiores eos minus dolores quaerat sequi magnam, aliquam ipsam!</p>
